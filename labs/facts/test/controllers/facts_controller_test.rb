...
class FactsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fact" do
    assert_difference('Fact.count') do
      post facts_url, params: { fact: { machine_id: @fact.machine_id, name: @fact.name, value: @fact.value } }
    end
  ...
  test "should update fact" do
    patch fact_url(@fact), params: { fact: { machine_id: @fact.machine_id, name: @fact.name, value: @fact.value } }
