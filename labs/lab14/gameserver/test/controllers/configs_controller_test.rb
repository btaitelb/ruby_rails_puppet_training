...
class ConfigsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create config" do
    assert_difference('Config.count') do
      post configs_url, params: { config: { game_type: @config.game_type, server_port: @config.server_port, server_url: @config.server_url } }
    end
  ...
  test "should update config" do
    patch config_url(@config), params: { config: { game_type: @config.game_type, server_port: @config.server_port, server_url: @config.server_url } }
